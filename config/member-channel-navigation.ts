...
export const MEMBER_RESEARCH_NAV: NavItem[] = [
  ...
  {
    key: "memberNav.dailyReview",
    href: NAV_ROUTES.memberDailyReview,
    labelZh: "每日预测复盘",
    labelEn: "Daily Forecast Review",
    groupKey: "forecast",
    groupZh: "市场预测",
    groupEn: "Forecasts",
  },
...
export function buildPublicFooterColumns(_options?: {
  ...
  const member: NavItem[] = [
    ...
    { key: "footer.memberDailyReview", href: NAV_ROUTES.memberDailyReview, labelZh: "每日预测复盘", labelEn: "Daily Forecast Review" },
