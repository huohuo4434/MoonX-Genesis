...
const SUPPLEMENTS: Readonly<Record<string, readonly FocusSupplementalEvidence[]>> = {
  ...
  sandisk: [
    ...
    },
    {
      ...
      sourcePublishedAt: null,
      lockedAt: null,
      summary: "易老师综合复核：本来源认为9月2日午后至4日偏回落、9月7—11日仍可能再找低点；但它与7月7日已发布的老师专项三个月原课发生方向分歧。现保留为低位与风险辅助，不再覆盖9月7日后正式偏上阶段。技术承接依次观察1,413—1,435、1,268和1,084。",
      gapNote: "本条仅作辅助点位与反方路径；老师原课来源优先。两者都不得改写已发生历史，日期或点位单独出现也不构成买卖信号。",
      includedInHistoricalHitRate: false,
    },
  ],
  bitcoin: [
