...
export const CONVICTION_ASSET_SEED: ConvictionAsset[] = [
  ...
  },
  {
    ...
    thesisZh: ["8月底前以磨底蓄势、后段转强为主。", "9月前中段是较强窗口，后段进入整理与修复。", "到年底按先升后反复处理，10—11月提高风险关注。", "没有独立日卦；逐日内容只能由正式周期卦与日历规则派生。"],
    thesisEn: ["Late August favors basing before improvement.", "Early-to-mid September is the stronger window before consolidation.", "The year-end path rises first, then becomes more volatile, with higher risk attention in October and November.", "No independent daily chart exists; daily views may only be derived from the locked period evidence."],
    catalystsZh: ["8月底蓄势后改善", "9月升卦主窗口", "六合承接"], catalystsEn: ["Late-August improvement", "September rising window", "Six-Harmony support"],
    risksZh: ["游魂与归魂反复", "10月波动放大", "11月伏神官鬼转旺", "无技术点位不得强行执行"], risksEn: ["Wandering/Returning-Soul volatility", "October volatility", "November hidden-risk window", "No execution without verified technical levels"],
