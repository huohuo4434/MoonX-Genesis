...
export const CONVICTION_ASSET_SEED: ConvictionAsset[] = [
  ...
  },
  {
    ...
    summaryZh: "SPCX多周期重点研究档案，覆盖逐周、1个月、3个月、1年和5年，并记录解锁后节奏修订。",
    summaryEn: "SPCX multi-horizon research covering weekly, one-month, three-month, one-year and five-year horizons with post-unlock timing revisions.",
    thesisZh: ["8月整体偏强但波动很大。", "8/17—23关注强势延续与第二轮供给压力。", "8/24—30结构相对顺畅。", "未来日节奏会结合最新行情滚动调整。"],
    thesisEn: ["August remains constructive but highly volatile.", "Aug 17–23 balances continuation with a second supply test.", "Aug 24–30 has the cleaner structure.", "Future daily rhythm is recalibrated as market action changes."],
    ...
    marketCap: null, marketCapCurrency: "USD", marketCapUpdatedAt: null, researchUpdatedAt: "2026-08-08", displayOrder: 16, isPublished: true, memberForecastStockId: null,
  },
  {
  ...
  },
  {
    ...
    summaryZh: "Lumentum多周期重点研究档案。MOOX已录入连续三周、8月17日至9月底和到年底六爻路线，并记录817.57、1032、1265、1680等波浪执行参考。",
