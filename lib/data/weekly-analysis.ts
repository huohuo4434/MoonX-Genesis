...
import {
  ...
  WEEKLY_RESEARCH_BLEND_NOTE_20260810_V3,
  WEEKLY_SOURCE_VERIFICATION_NOTE_20260810_V3,
...
export function buildWeeklyPublicSummary(now = new Date()): WeeklyAnalysisPublicSummary {
  ...
  return {
    ...
    researchBlendNoteZh: window.weekStart === "2026-08-10" ? WEEKLY_RESEARCH_BLEND_NOTE_20260810_V3.zh : undefined,
    researchBlendNoteEn: window.weekStart === "2026-08-10" ? WEEKLY_RESEARCH_BLEND_NOTE_20260810_V3.en : undefined,
    sourceVerificationNoteZh: window.weekStart === "2026-08-10" ? WEEKLY_SOURCE_VERIFICATION_NOTE_20260810_V3.zh : undefined,
    sourceVerificationNoteEn: window.weekStart === "2026-08-10" ? WEEKLY_SOURCE_VERIFICATION_NOTE_20260810_V3.en : undefined,
  };
}
