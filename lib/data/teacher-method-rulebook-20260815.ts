...
const RULEBOOK: TeacherMethodRulebook = {
  ...
  rules: [
    ...
    { id: "moox-conditional-liuyao-authority", method: "MOOX_POLICY", status: "MOOX_INTERPRETATION", title: "丙午老师唯一优先，狼叔与自起卦同级裁决", summary: "丙午老师是六爻来源唯一第一优先级。狼叔与用户按老师法解读的同周期六爻默认各50%；两者冲突时不得默认选择狼叔，只有在发布前由奇门、至少3名独立已批准博主的严格多数和完整缠论结构三层同向支持其中一方时才完成裁决，否则并列展示、降低信心并人工复核。", sourceArtifactId: "MOOX-POLICY", sourcePublishedAt: null, executionAuthority: "RESEARCH_ONLY" },
