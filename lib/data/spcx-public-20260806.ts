...
export const SPCX_PUBLIC_RESEARCH = {
  ...
  publicSummaryZh:
    "易K先生从“结构力量”和“时序演变”两个角度交叉分析，均未给出“解锁后一路下跌”的单一路径。更值得观察的是：前段仍会剧烈消化抛压，真正偏强的时间窗口集中在8月下旬至9月初。",
  publicSummaryEn:
    "Mr. Yi K cross-checks SPCX through two complementary lenses—structural forces and temporal evolution. Neither supports a simple post-unlock collapse. The more important setup is an early supply-absorption phase followed by a stronger late-August to early-September window.",
  publicWindows: [
    {
  ...
  teaserZh:
    "会员版已锁定：易K先生双框架依据、周级路径、最强窗口、实时技术确认、失效条件与事后验证。",
  teaserEn:
    "Member research includes Mr. Yi K’s two-framework evidence, the weekly path, strongest window, live technical confirmation, invalidation and post-event verification.",
  disclaimerZh:
