...
export const WU_LIQUIDITY_REVIEW_20260913 = {
  version: "wu-liquidity-20260913-v1",
  recordedOn: "2026-09-13",
  classification: "RESEARCH_ONLY",
  source: { author: "吴昌燁", videoId: "ghriN1BWfxc", filmedAt: "2026-09-10T12:10:00+08:00" },
  revisionReason: "Add the Sep 28 watch threshold and October–early November technology-liquidity scenario; retain existing dated directions and the Aug 20 risk prior.",
  ...
  evidence: [
    ...
    { time: "02:54–03:42", finding: "美联储不敢轻易加息或降息，也提及有限度加息；不能计为9月不加息的新确认。日本加息属于作者情景。" },
  ...
  zh: {
    ...
    detail: "重点检查已闭合日K的支撑压力、EMA60和MACD动能，并结合周线；这些是后续确认条件，不表示目前已经触发。9月不加息仍是待决议验证的独立判断，本次不加分。日本政策、油价和地缘变化作为条件观察；回调后也须重新确认底部，不预设11月初一定买入。",
