...
export const TEACHER_SOURCE_WEIGHT_PROFILES: TeacherSourceWeightProfile[] = [
  {
    ...
    symbol: "GOLD",
    label: "黄金",
    teacher01WeightPct: 45,
    teacher02WeightPct: 45,
    moonxExtensionWeightPct: 10,
    note: "贵金属专项老师在黄金上提高基础权重；累计至少10个同市场、同周期、同环境正式样本后再按真实命中率动态调整。",
  },
  {
    assetId: "silver",
    symbol: "SILVER",
    label: "白银",
    teacher01WeightPct: 50,
    teacher02WeightPct: 40,
    moonxExtensionWeightPct: 10,
    note: "贵金属专项老师在白银上提高基础权重；白银波动大于黄金，方向与转折时间分开复盘。",
  },
  {
    assetId: "nasdaq-100",
    symbol: "NDX",
  ...
  },
  {
    ...
    teacher02WeightPct: 25,
    moonxExtensionWeightPct: 10,
    note: "提高该老师未来完整ETH前瞻的基础权重；必须使用UTC且不允许凭复盘补造方向或单独触发开仓。",
  },
  {
    assetId: "sp500",
    symbol: "SPX",
