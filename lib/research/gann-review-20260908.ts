...
export const gannReviewAssets: ReviewAsset[] = [
  ...
  { symbol: "MU", assetId: "mu", market: "semiconductor",
  ...
  ...([
    ...
    ["LITE", "lite", "较大结构偏积极，下一段上涨仍要等回调结束。", "The larger structure looks constructive, but another advance needs a completed correction."],
    ["MSFT", "msft", "较大结构偏积极，与近端回调可以并存。", "A constructive larger structure can coexist with a near-term correction."],
