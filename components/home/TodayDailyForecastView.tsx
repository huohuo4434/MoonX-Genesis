              ...
              {forecasts.map((f) => {
                ...
                return (
                  ...
                  >
                    ...
                    {ready && (
                      <div className="mt-auto space-y-2 border-t border-border/[0.06] pt-3 text-caption text-foreground-tertiary">
                        <p>
                          {t("home.todayFirstPublished")}{" "}
                          {formatBeijingDateTime(f.publishedAt)}
                        </p>
                        <p>
