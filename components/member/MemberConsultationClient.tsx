    ...
    <div className="space-y-6">
      ...
      <Card padding="lg">
        ...
        <form action={submit} className="mt-6 space-y-5">
          ...
          <label className="flex items-start gap-2 rounded-xl border border-border/20 p-4 text-body-sm"><input type="checkbox" name="consent" required className="mt-1" /><span>同意加密保存本次资料，并由易老师人工查看问题和原始卦象、完成解答；最终答复发送到填写邮箱，并保存在会员中心。</span></label>
