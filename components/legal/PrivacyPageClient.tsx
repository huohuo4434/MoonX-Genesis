    ...
    <main>
      <Section spacing="lg" className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 space-y-8 text-body-sm text-foreground-secondary">
          ...
          <section className="space-y-2"><h2 className="text-body font-semibold text-foreground">{en ? "4. Payment data" : "4. 付款数据"}</h2><p>{en ? "For manual review, we store the plan, list price, actual amount, discount snapshot, order status, network and transaction hash. We never request wallet private keys or seed phrases." : "为完成人工审核，我们会保存套餐、标价、实付金额、折扣快照、订单状态、网络和交易哈希。我们不会索取钱包私钥或助记词。"}</p></section>
