    ...
    <main>
      <Section spacing="lg" className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 space-y-8 text-body-sm text-foreground-secondary">
          ...
          <section className="space-y-2"><h2 className="text-body font-semibold text-foreground">{en ? "Payment and review" : "付款与审核"}</h2><p>{en ? "Choose a plan, send USDT over TRC20 or BEP20 to the address shown at checkout and submit the transaction hash. Submission enters verification and manual review; membership starts only after approval." : "请选择套餐，使用USDT（TRC20或BEP20）转账至付款页面显示的指定地址并提交交易哈希。提交后进入待核验与人工审核流程；提交哈希不等于审核通过，审核通过后会员权限才会生效。"}</p></section>
