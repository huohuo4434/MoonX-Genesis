...
export function DailyAccuracyClient({ items, stats }: { items: PublicAccuracyHistoryItem[]; stats: DailyAccuracyStats }) {
  ...
  const stableSample = displayStats.verifiedCount >= 30;
  ...
  const statsCards = [
    ...
    [en ? "Full-path accuracy" : "完整路径命中率", provisional(displayStats.pathHitRate)],
