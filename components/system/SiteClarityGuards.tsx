...
function enhanceMemberMultiView(): void {
  ...
  if (main.dataset.mooxAlphaFeedNative === "1" || main.dataset.mooxServerMultiView === "1" || Boolean(main.dataset.mooxAssetOpinionMatrix) || main.querySelector('[data-moox-alpha-feed-native="1"], [data-moox-server-multi-view="1"], [data-moox-asset-opinion-matrix]')) return;
