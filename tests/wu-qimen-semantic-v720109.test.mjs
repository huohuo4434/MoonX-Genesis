...
assert(qimen.includes("QIMEN_PRIMARY_WU_SEMANTIC_LIUYAO_AUX_MARKET_BAZI_REGIME_V4"), "Wu semantic + market-Bazi policy version missing");
...
assert(registry.version === "7.20.10.9", "Financial Qimen method registry version mismatch");
