...
export default function SupportPage() {
  return <main><Section spacing="lg"><div className="mx-auto max-w-4xl space-y-6">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Card padding="lg"><Heading as="h2" size="h3">联系邮箱</Heading><div className="mt-4 text-body-sm"><p><a className="text-primary" href={`mailto:${siteConfig.supportEmail}`}>{siteConfig.supportEmail}</a></p></div><Text variant="caption" color="tertiary" className="mt-3 block">统一用于一般支持、账务付款和隐私请求。作为网页联系邮箱不需要在Vercel验证。</Text></Card>
    </div>
