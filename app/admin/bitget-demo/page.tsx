        ...
        <Section spacing="lg">
          ...
          <div className="space-y-8">
            ...
            <Card padding="lg" className="border-red-400/25 bg-red-400/[0.035]">
              ...
              <Text variant="body-sm" color="secondary" className="mt-2 block leading-relaxed">
                首笔闭环验收风险预算0.05%，最长持有30分钟；系统从正式允许池选择玄学方向最明确的可交易品种，BTC/ETH只有在允许池中才优先；短线、波段和中长期单笔计划风险分别为0.25%、0.35%和0.25%。每天最多新开10笔，最多同时持有10个仓位，单仓名义价值不超过账户权益30%且默认不超过300 USDT；单日账户亏损达到100 USDT后停止当天新开仓，总权益较峰值回撤达到500 USDT后停止实验并尝试平掉全部仓位。系统只在条件满足时下单，不会为了凑满10笔或10个仓位强行交易。
              </Text>
            </Card>
