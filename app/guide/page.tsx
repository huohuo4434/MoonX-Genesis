...
const QUESTIONS_ZH = [
  {
    title: "MOOX是什么？",
    body: "MOOX不是单纯喊涨跌，也不是保证盈利的机器人。它把方向、运行路径、确认条件、关键价位、止损止盈和公开验证连接成一套可复盘流程。",
  },
  {
    title: "我每天先看哪里？",
  ...
  {
    title: "预测卡片怎么读？",
    body: "先读方向和运行路径，再看确认条件与失效条件。概率是不同情景的相对权重，不是历史命中率。",
  },
  {
    title: "什么时候可以交易？",
  ...
  {
    title: "判断错了怎么处理？",
    body: "一旦触发失效条件，就停止坚持旧判断，等待下一轮结构重新形成。止损和复盘比证明自己正确更重要。",
  },
] as const;
