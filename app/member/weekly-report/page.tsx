      ...
      <main>
        <Section spacing="lg">
          <div className="mx-auto w-full max-w-6xl space-y-9">
            ...
            <div className="flex flex-wrap gap-3"><Link href="/member/annual-outlook" className="rounded-full border border-primary/25 px-4 py-2 text-body-sm text-primary">年度路线</Link><Link href="/member/sector-resonance" className="rounded-full border border-primary/25 px-4 py-2 text-body-sm text-primary">板块共振</Link><Link href="/member/daily-review" className="rounded-full border border-primary/25 px-4 py-2 text-body-sm text-primary">每日复盘</Link><Link href="/member/stock-picks" className="rounded-full border border-primary/25 px-4 py-2 text-body-sm text-primary">股票研究</Link><Link href="/member/crypto-picks" className="rounded-full border border-primary/25 px-4 py-2 text-body-sm text-primary">加密研究</Link><Link href="/verification" className="rounded-full border border-border/20 px-4 py-2 text-body-sm text-foreground-secondary">上周验证</Link></div>
          </div>
        </Section>
      </main>
    </>
