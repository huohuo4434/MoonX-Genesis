...
import { MemberTradingOnboardingLazy } from "@/components/member/MemberTradingOnboardingLazy";
...
export default async function MemberAiTradingPage() {
  ...
  return <main><Section spacing="lg"><MemberDeviceHeartbeat /><MemberAiTradingDashboardLazy /><MemberTradingOnboardingLazy /></Section></main>;
}
